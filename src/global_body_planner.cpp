...
GlobalBodyPlanner::GlobalBodyPlanner(ros::NodeHandle nh) {
  ...
  body_plan_pub_ = nh_.advertise<global_body_planner::BodyPlan>(body_plan_topic,1);
  discrete_body_plan_pub_ = nh_.advertise<global_body_planner::BodyPlan>(discrete_body_plan_topic,1);
